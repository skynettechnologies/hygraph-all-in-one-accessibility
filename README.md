...
Checkout the steps for upgrading **[Free to Paid Widget](https://www.skynettechnologies.com/blog/upgrade-all-in-one-accessibility-free-widget-to-paid-version#free-paid-version).**
...
1.  Go to **Hygraph Studio** -> **Apps** -> **All in One Accessibility**.
2.  Click on **Install** option.

## Setup & Usage

1.  Click on **Select Project** option where you want to install the App.
2.  Select **Environment** option on which project environment branch you want to install the App.
3.  Once the App is installed, go to **Apps** section, select **Edit** option for **All in One Accessibility** Settings Page.
...
## Demo URL
https://hygraph-all-in-one-accessibility.netlify.app
